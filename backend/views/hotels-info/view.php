...
</div></div><?php Pjax::begin(['id'=>'pjax-TourInfos', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-TourInfos ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
