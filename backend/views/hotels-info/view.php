    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'format' => 'html',
                'attribute' => 'city_id',
                'value' => ($model->getCity()->one() ? Html::a($model->getCity()->one()->name, ['city/view', 'id' => $model->getCity()->one()->id,]) : '<span class="label label-warning">?</span>'),
            ],
            'address:ntext',
...
// generated by schmunk42\giiant\generators\crud\providers\RelationProvider::columnFormat
    ...
    <div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
            ...
            <?= Html::a(
                ...
                ['tour-info/create', 'TourInfo' => ['hotels_info_id' => $model->id]],
                ['class'=>'btn btn-success btn-xs']
            ); ?>
    ...
    <?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
        'layout' => '{summary}{pager}<br/>{items}{pager}',
        'dataProvider' => new \yii\data\ActiveDataProvider(['query' => $model->getTourInfos(), 'pagination' => ['pageSize' => 20, 'pageParam'=>'page-tourinfos']]),
        'pager'        => [
            'class'          => yii\widgets\LinkPager::className(),
            'firstPageLabel' => Yii::t('app', 'First'),
            'lastPageLabel'  => Yii::t('app', 'Last')
