...
<label>
    Маршрут "обратно"
                ...
                <?= $form->field($model, 'reverse_name')->textInput() ?>
...
HTML;
                ...
                <?= $form->field($model, 'reverse_active')->checkbox() ?>
    ...
    <div class="form-group">
        ...
        <?php if (Yii::$app->controller->action->id == 'generate'): ?>
            <?= Html::submitButton(Yii::t('app', 'Сгенерировать'), ['class' => 'btn btn-info', 'value' => '1', 'name' => '_asnew']) ?>
        <?php endif; ?>
