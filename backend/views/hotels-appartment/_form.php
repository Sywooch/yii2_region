...
<div class="hotels-appartment-form">
    ...
    <div class="">
        ...
        <p>
            ...
            $("#hotelsappartment-hotelsinfo").on("pjax:end", function() {
            $.pjax.reload({container:"#hotelsappartment-hotels_info_id"});
        });
    });']
            ); ?>
            $.pjax.reload({url:'http://xyz.php?Model[fielda]=123',container: '#gridSoal',timeout: 1000,type:'GET'

            <?php
            \yii\widgets\Pjax::begin(['id' => 'hotelsappartment-hotelsinfo']);
            ?>
