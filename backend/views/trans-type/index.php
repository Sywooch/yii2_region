...
/* @var $searchModel backend\models\SearchTransType */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Trans Types');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' ' . Yii::t('app', 'Trans Types'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> '. Yii::t('app', 'Trans Types') . ' ' . Yii::t('app', 'listing'),
