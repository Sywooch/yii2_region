 ...
 * @var backend\models\SearchHotelsPayPeriod $searchModel
 */
...
?>
<div class="giiant-crud hotels-pay-period-index">
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        if ($rel = $model->getHotelsPricing()->one()) {
                            return Html::a($rel->name, ['hotels-pricing/view', 'id' => $rel->id,], ['data-pjax' => 0]);
                        } else {
                            return '';
                        }
                    },
