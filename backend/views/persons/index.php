...
/* @var $searchModel backend\models\SearchPersons */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . Yii::t('app', 'Persons'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> '. Yii::t('app', 'Persons') . Yii::t('app', 'listing'),
