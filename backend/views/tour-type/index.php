...
/* @var $searchModel backend\models\SearchTourType */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new Tour Types'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i>' . Yii::t('app', 'Tour Types listing'),
