...
/* @var $searchModel backend\models\SearchUserRole */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t( 'app ', 'Create new') . ' ' . Yii::t( 'app ', 'User Roles'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> ' . Yii::t( 'app ', 'User Roles') . ' ' . Yii::t( 'app ', 'listing'),
