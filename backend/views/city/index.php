        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . Yii::t('app', 'Cities'),'class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> '. Yii::t('app', 'Cities') . Yii::t('app', 'listing'),
