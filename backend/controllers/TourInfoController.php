...
class TourInfoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Create new TourInfo'),
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> Yii::t('app', 'Create new TourInfo'),
                    'content'=>'<span class="text-success">'. Yii::t('app', 'Create TourInfo success').'</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title' => Yii::t('app', 'Update TourInfo #').$id,
    ...
    /**
     * Delete an existing TourInfo model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TourInfo model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (TourInfo::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
