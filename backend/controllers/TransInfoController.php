...
class TransInfoController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new TransInfo",
                    'content'=>'<span class="text-success">Create TransInfo success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    {        
        ...
        foreach (TransInfo::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
