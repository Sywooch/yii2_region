...
class BusWayController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new BusWay",
                    'content'=>'<span class="text-success">Create BusWay success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    {        
        ...
        foreach (BusWay::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
