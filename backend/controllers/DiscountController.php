...
class DiscountController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Create new') . ' ' . Yii::t('app', 'Discount'),
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> Yii::t('app', 'Update') . ' ' . Yii::t('app', 'Discount') . ' #' .$id,
    ...
    {        
        ...
        foreach (Discount::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
