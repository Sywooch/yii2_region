    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new SalOrderStatus",
                ...
                return [
                    ...
                    'title'=> "Create new SalOrderStatus",
                    'content'=>'<span class="text-success">Create SalOrderStatus success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update SalOrderStatus #".$id,
