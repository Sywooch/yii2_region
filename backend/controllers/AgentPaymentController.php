...
use backend\models\SearchAgentPayment;
...
class AgentPaymentController extends Controller
{
    ...
    /**
     * Creates a new AgentPayment model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new AgentPayment();
    ...
    /**
     * Updates an existing AgentPayment model.
    ...
    /**
     * Deletes an existing AgentPayment model.
    ...
    /**
    * Creates a new AgentPayment model by another data,
