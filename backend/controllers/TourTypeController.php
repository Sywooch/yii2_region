...
class TourTypeController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new TourType",
                    'content'=>'<span class="text-success">Create TourType success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    {        
        ...
        foreach (TourType::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }
