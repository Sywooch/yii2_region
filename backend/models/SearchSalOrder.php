...
class SearchSalOrder extends SalOrder
{
    ...
    {
        return [
            [['id', 'sal_order_status_id', 'enable', 'hotels_info_id', 'hotels_appartment_id', 'trans_info_id', 'hotels_type_of_food_id', 'user_id', 'tour_info_id', 'created_by', 'updated_by', 'lock'], 'integer'],
