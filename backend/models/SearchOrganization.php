...
/**
 * backend\models\SearchOrganization represents the model behind the search form about `common\models\Organization`.
 */
 class SearchOrganization extends Organization
{
    ...
    {
        return [
            [['id', 'inn', 'kpp', 'ogrn', 'bik', 'created_by', 'updated_by', 'lock', 'active'], 'integer'],
